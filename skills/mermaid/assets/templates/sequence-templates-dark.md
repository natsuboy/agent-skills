# Sequence Diagram Dark 模板库

本文档提供适用于深色背景编辑器的高质量时序图模板，可直接复制使用。
...
| 元素 | 推荐颜色（dark 主题） |
|------|------------------------|
| 参与者背景 | `#4dabf7`（浅蓝）、`#69db7c`（浅绿） |
| 参与者边框 | `#1864ab`（深蓝）、`#2b8a3e`（深绿） |
| 信号线 | `#e9ecef`（浅灰） |
| 信号文字 | `#f8f9fa`（几乎白色） |
| 激活框 | `#343a40`（深灰） |
